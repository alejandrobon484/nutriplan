...
import { Leaf, Snowflake, Sun, CloudRain, User, Calendar, Target, Heart, Apple, Menu, X, Moon } from 'lucide-react';
...
type Season = 'primavera' | 'verano' | 'otono' | 'invierno';
  ...
  const seasonColors: Record<Season, string> = {
    primavera: 'bg-emerald-50 dark:bg-emerald-950 border-emerald-300 dark:border-emerald-700 text-emerald-800 dark:text-emerald-200',
    verano: 'bg-amber-50 dark:bg-amber-950 border-amber-300 dark:border-amber-700 text-amber-800 dark:text-amber-200',
    otono: 'bg-orange-50 dark:bg-orange-950 border-orange-300 dark:border-orange-700 text-orange-800 dark:text-orange-200',
    invierno: 'bg-sky-50 dark:bg-sky-950 border-sky-300 dark:border-sky-700 text-sky-800 dark:text-sky-200'
  };

  const seasonActiveColors: Record<Season, string> = {
    primavera: 'bg-emerald-500 dark:bg-emerald-600 border-emerald-500 dark:border-emerald-600 text-white',
    verano: 'bg-amber-500 dark:bg-amber-600 border-amber-500 dark:border-amber-600 text-white',
    otono: 'bg-orange-500 dark:bg-orange-600 border-orange-500 dark:border-orange-600 text-white',
    invierno: 'bg-sky-500 dark:bg-sky-600 border-sky-500 dark:border-sky-600 text-white'
  };
...
type Day = 'lunes' | 'martes' | 'miercoles' | 'jueves' | 'viernes' | 'sabado' | 'domingo';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <div className="flex items-center gap-2 sm:gap-3 cursor-pointer" onClick={() => handleNavClick('home')}>
            <div className="bg-emerald-100 dark:bg-emerald-900 p-1.5 sm:p-2 rounded-lg">
              <Apple className="w-5 h-5 sm:w-7 sm:h-7 text-emerald-600 dark:text-emerald-400" />
            </div>
            <span className="text-xl sm:text-2xl font-light text-slate-800 dark:text-slate-100">
              Nutri<span className="font-semibold text-emerald-600 dark:text-emerald-400">Plan</span>
            </span>
          </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button
              ...
              className={`text-sm font-medium uppercase tracking-wide transition-colors ${
                profile 
                  ? 'bg-emerald-600 dark:bg-emerald-500 text-white px-6 py-2.5 rounded-lg hover:bg-emerald-700 dark:hover:bg-emerald-600 shadow-sm'
                  : 'text-slate-600 dark:text-slate-300 hover:text-emerald-600 dark:hover:text-emerald-400'
              }`}
            >
              Mi Plan
  ...
  const AboutPage = () => (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 via-white to-emerald-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-8 sm:py-16 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8 sm:mb-12">
          <h1 className="text-3xl sm:text-5xl font-light text-slate-800 dark:text-slate-100 mb-4">
            Sobre <span className="font-semibold text-emerald-600 dark:text-emerald-400">Nosotros</span>
          </h1>
        </div>
        <div className="bg-white dark:bg-slate-800 rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 p-6 sm:p-12">
          <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300 leading-relaxed mb-6">
            En NutriPlan creemos que una alimentación saludable debe estar en armonía con las estaciones del año. 
  ...
  const ContactPage = () => (
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 via-white to-emerald-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-8 sm:py-16 px-4 sm:px-6">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8 sm:mb-12">
          <h1 className="text-3xl sm:text-5xl font-light text-slate-800 dark:text-slate-100 mb-4">
            <span className="font-semibold text-emerald-600 dark:text-emerald-400">Contacto</span>
          </h1>
        </div>
        <div className="bg-white dark:bg-slate-800 rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 p-6 sm:p-12">
          <div className="space-y-6 sm:space-y-8">
            <div>
              <h3 className="text-lg sm:text-xl font-semibold text-slate-800 dark:text-slate-100 mb-2">Email</h3>
              <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300">info@nutriplan.com</p>
            </div>
            <div>
              <h3 className="text-lg sm:text-xl font-semibold text-slate-800 dark:text-slate-100 mb-2">Horario</h3>
              <p className="text-base sm:text-lg text-slate-600 dark:text-slate-300">Lunes a Viernes: 9:00 - 18:00</p>
            </div>
  ...
  const Footer = () => (
    <footer className="bg-slate-100 dark:bg-slate-900 text-slate-700 dark:text-slate-300 mt-8 sm:mt-12 border-t border-slate-200 dark:border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-6 sm:mb-8">
          <div className="sm:col-span-2 md:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xl font-light text-slate-800 dark:text-slate-100">
                Nutri<span className="font-semibold text-emerald-600 dark:text-emerald-400">Plan</span>
              </span>
            </div>
          ...
          <div>
            <h3 className="text-slate-800 dark:text-slate-100 font-semibold mb-4 uppercase tracking-wide text-sm">Enlaces</h3>
            <ul className="space-y-2">
              <li>
                <button onClick={() => handleNavClick('home')} className="text-sm hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                  Inicio
                </button>
              </li>
              <li>
                <button onClick={() => handleNavClick('about')} className="text-sm hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                  Sobre Nosotros
                </button>
              </li>
              <li>
                <button onClick={() => handleNavClick('contact')} className="text-sm hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
                  Contacto
                </button>
              </li>
              <li>
          ...
          <div>
            <h3 className="text-slate-800 dark:text-slate-100 font-semibold mb-4 uppercase tracking-wide text-sm">Legal</h3>
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-sm hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors">
          ...
          <div>
            <h3 className="text-slate-800 dark:text-slate-100 font-semibold mb-4 uppercase tracking-wide text-sm">Contacto</h3>
            <ul className="space-y-2 text-sm">
              <li className="flex items-start gap-2">
                <span className="text-emerald-600 dark:text-emerald-400 mt-1 font-medium">Email:</span>
                <span>info@nutriplan.com</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-600 dark:text-emerald-400 mt-1 font-medium">Lugar:</span>
        ...
        <div className="border-t border-slate-300 dark:border-slate-700 pt-6 sm:pt-8">
  ...
  if (!profile) {
    return (
      <div className="min-h-screen bg-white dark:bg-slate-900 flex flex-col">
        <NavigationBar />
        {currentView === 'home' && (
          <div className="flex-grow min-h-screen bg-gradient-to-b from-emerald-50 via-white to-emerald-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-8 sm:py-16 px-4 sm:px-6">
            <div className="max-w-5xl mx-auto">
              <div className="text-center mb-8 sm:mb-16">
                <div className="flex justify-center mb-4 sm:mb-6">
                  <div className="bg-emerald-100 dark:bg-emerald-900 p-3 sm:p-4 rounded-full">
                    <Apple className="w-12 h-12 sm:w-16 sm:h-16 text-emerald-600 dark:text-emerald-400" />
                  </div>
                </div>
                <h1 className="text-3xl sm:text-5xl font-light text-slate-800 dark:text-slate-100 mb-3 sm:mb-4 px-4">
                  Plan Nutricional <span className="font-semibold text-emerald-600 dark:text-emerald-400">Personalizado</span>
                </h1>
              ...
              <div className="bg-white dark:bg-slate-800 rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 p-6 sm:p-12 max-w-3xl mx-auto">
                <div className="flex items-center mb-6 sm:mb-8 pb-4 sm:pb-6 border-b border-slate-100 dark:border-slate-700">
                  <User className="w-6 h-6 sm:w-8 sm:h-8 text-emerald-600 dark:text-emerald-400 mr-3 sm:mr-4 flex-shrink-0" />
                  <h2 className="text-2xl sm:text-3xl font-light text-slate-800 dark:text-slate-100">Tu Perfil</h2>
                </div>
                ...
                <div className="space-y-6 sm:space-y-8">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-8">
                    <div>
                      ...
                      <input
                        ...
                        min="15"
                        max="100"
                        className="w-full px-4 sm:px-5 py-3 sm:py-4 border border-slate-200 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-700 text-slate-900 dark:text-slate-100 focus:border-emerald-500 dark:focus:border-emerald-400 focus:ring-2 focus:ring-emerald-200 dark:focus:ring-emerald-800 focus:outline-none transition-all text-base sm:text-lg"
                        placeholder="30"
                      />
                    </div>
                  ...
                  <button
                    ...
                    className="w-full bg-emerald-600 dark:bg-emerald-500 text-white font-medium py-4 sm:py-5 rounded-xl hover:bg-emerald-700 dark:hover:bg-emerald-600 transition-all duration-300 shadow-lg shadow-emerald-200 dark:shadow-emerald-900/50 text-base sm:text-lg mt-4"
                  >
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 flex flex-col">
      <NavigationBar />
      <div className="flex-grow min-h-screen bg-gradient-to-b from-emerald-50 via-white to-emerald-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 py-6 sm:py-12 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto">
          <div className="bg-white dark:bg-slate-800 rounded-2xl sm:rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 p-4 sm:p-8 mb-6 sm:mb-12">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6">
              <div>
                <h1 className="text-2xl sm:text-4xl font-light text-slate-800 dark:text-slate-100 mb-2 sm:mb-3">
                  Tu Plan <span className="font-semibold text-emerald-600 dark:text-emerald-400">Nutricional</span>
                </h1>
                <div className="flex flex-col sm:flex-row sm:flex-wrap sm:items-center gap-3 sm:gap-6 text-slate-600 dark:text-slate-300">
                  <div className="flex items-center gap-2">
                    <Heart className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-600 dark:text-emerald-400" />
                    <span className="text-base sm:text-lg">
                      <span className="font-semibold text-emerald-600 dark:text-emerald-400">{profile.calorias}</span> kcal/día
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Target className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-600 dark:text-emerald-400" />
                    <span className="text-base sm:text-lg">
                      {profile.peso} kg → <span className="font-semibold text-emerald-600 dark:text-emerald-400">{profile.pesoObjetivo} kg</span>
                    </span>
                  </div>
                </div>
              </div>
              <button
                ...
                className="w-full sm:w-auto px-4 sm:px-6 py-2.5 sm:py-3 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 rounded-xl text-slate-700 dark:text-slate-200 font-medium transition-colors text-sm sm:text-base"
              >
                Modificar Perfil
              </button>
            </div>
          ...
          <div className="mb-8 sm:mb-12">
            <h2 className="text-xl sm:text-2xl font-light text-slate-800 dark:text-slate-100 text-center mb-6 sm:mb-8">
              Selecciona tu <span className="font-semibold text-emerald-600 dark:text-emerald-400">Estación</span>
            </h2>
          ...
          <div className="space-y-4 sm:space-y-6">
            {dias.map((dia) => (
              <div key={dia} className="bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden hover:shadow-md transition-shadow">
                <div className="bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-950 dark:to-teal-950 px-4 sm:px-8 py-3 sm:py-5 border-b border-slate-100 dark:border-slate-700">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <Calendar className="w-5 h-5 sm:w-6 sm:h-6 text-emerald-600 dark:text-emerald-400" />
                    <h3 className="text-xl sm:text-2xl font-light text-slate-800 dark:text-slate-100 capitalize">
                ...
                <div className="p-4 sm:p-8 grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-8">
                  <div>
                    <div className="flex items-center gap-2 mb-2 sm:mb-3">
                      ...
                      <h4 className="font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wide text-xs sm:text-sm">Desayuno</h4>
                    </div>
                    <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 leading-relaxed">{seasonalMeals[season][dia].desayuno}</p>
                  </div>
                  <div>
                    <div className="flex items-center gap-2 mb-2 sm:mb-3">
                      <div className="w-2 h-2 rounded-full bg-orange-500"></div>
                      <h4 className="font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wide text-xs sm:text-sm">Comida</h4>
                    </div>
                    <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 leading-relaxed">{seasonalMeals[season][dia].comida}</p>
                  </div>
                  <div>
                    <div className="flex items-center gap-2 mb-2 sm:mb-3">
                      <div className="w-2 h-2 rounded-full bg-indigo-500"></div>
                      <h4 className="font-semibold text-slate-700 dark:text-slate-300 uppercase tracking-wide text-xs sm:text-sm">Cena</h4>
                    </div>
                    <p className="text-sm sm:text-base text-slate-600 dark:text-slate-400 leading-relaxed">{seasonalMeals[season][dia].cena}</p>
                  </div>
                </div>
              </div>
            ))}
